...
# Useable Security
As an illustration of the statistical (process control) opportunities in improving the utilization of human-generated data for cyber security applications, let us examine the dataset from @mohamed2016gametrics.  <font color="red">Manar, please add 3-5 sentences describing the experiment here</font>.
